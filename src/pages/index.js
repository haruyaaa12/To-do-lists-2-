  ...
  return (
    <>
      <div className="addTask">
        <button type="button" className="addTaskButton" onClick={handleAddButtonClick}>Add</button>
      </div>
      ...
      <div className="tab">
        <button className={`tablinks ${activeTab === "ToDo" ? "active" : ""}`} onClick={() => openTab("ToDo")}>To-Do List</button>
        <button className={`tablinks ${activeTab === "Completed" ? "active" : ""}`} onClick={() => openTab("Completed")}>Completed</button>
      </div>
      ...
      <div id="ToDo" className={`tabcontent ${activeTab === "ToDo" ? "active" : ""}`}>
        <ul className="task-list">
          {toDoList.map((task, index) => (
            <li key={index}>
              <span>{task.name}</span>
              <button className="complete-button" onClick={() => handleCompletedButtonClick(index)}>Completed</button>
              <button className="edit-button" onClick={() => handleEditButtonClick(index)}>Edit</button>
              <button className="delete-button" onClick={() => handleDeleteButtonClick(index)}>Delete</button>
            </li>
          ))}
        </ul>
      </div>
